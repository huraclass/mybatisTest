...
public class CalenderController {
    ...
    public ResponseEntity insertCalender(Calender calender) {
        try {
    ...
    public ResponseEntity deleteCalender(Calender calender) {
        try {
    ...
    public ResponseEntity updateCalender(Calender calender) {
        try {
